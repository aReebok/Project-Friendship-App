...
function RelationshipCard (props) {
    ...
    const { person, role, hasMentor, cid, 
                ...
                <View style={{backgroundColor: '#f0f0f0', padding: 10, marginBottom: 5, borderRadius: 5}}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                        <View style={{flex:3}}>
                            ...
                            <Text>Mentor:  <Text style={{fontWeight:'300'}}>{mentorInfo.first} {mentorInfo.last[0]}. ()</Text></Text> 
        ...
        return(<View style={{backgroundColor: '#f0f0f0', padding: 10, marginBottom: 5, borderRadius: 5}}>
            ...
            { parentsInfo.map((item, index) => {
                return <View style={{backgroundColor: '#f0f0f0'}}>
                            <Text style={{fontWeight: '500', fontSize: 15,}}>  {item.first} {item.last[0]}. <Text style={{fontWeight:'300'}}>(pronouns)</Text></Text>
                            <View style={{flexDirection: 'row'}}>
                                <Text>  Phone Number: </Text>
