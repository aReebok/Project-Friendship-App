    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        onRequestClose={() => {
          ...
          <View style={[styles.modalView, {height: deviceHeight*0.66, margin:0, marginTop: deviceHeight*0.075}]}>
      ...
      <Modal
        ...
        onRequestClose={() => {
          ...
          <View style={[styles.modalView, {marginTop: deviceHeight*0.25, height: deviceWidth*1.15}]}>
      ...
      <View style={{flex: 13}}>
        <View style={{flex: 12.5, justifyContent: "center", alignItems:"center" }}>
