...
function EventForm (props) {
    ...
    const {sid, event, email, setConfirmed, setDateOnCard,
    ...
    const sendEvent = async () => {
        ...
        let emailList = await APICalls.getEmailsToNotify(event.cid, email);
        await notify(emailList, "New Time Suggestion", `${event.title} at ${event.eventlocation}.`)
