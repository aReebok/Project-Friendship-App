    ...
    return( 
        <View style={styles.container}>
            ...
            <View style={{flexDirection: 'row', paddingTop: 40}}>
                <TouchableOpacity onPress={()=>props.navigation.navigate('Directory')}>
                    <Icon name='book' size={60} color={logo.red}/>
                    <Text>DIRECTORY</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{paddingHorizontal: 30}} onPress={() => onPressLogOut()}>
