                ...
                <View style={styles.notifCard_event}>
                    <View style={{flex: 2.5, flexDirection:'row', }}>
                        ...
                        <View style={{flex:2}}>
                            ...
                            { Platform.OS === 'ios' ?<Text style={styles.subtitle}>Suggested: <Text style={{fontWeight: '500'}}>{date.toLocaleDateString('en-US', optionsDate)} at {eventDate.toLocaleTimeString('en-US', optionsTime)}</Text></Text> :
                            <Text style={styles.subtitle}>Suggested: <Text style={{fontWeight: 'bold'}}>{Intl.DateTimeFormat('en-US', optionsDate).format(date)} at {Intl.DateTimeFormat('en-US', optionsTime).format(eventDate)}</Text></Text>}
                        </View>
                    </View>
