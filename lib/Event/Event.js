...
return ( <View style={styles.container}>
    ...
    <EventEditingForm eventEditingFormModalVisible={eventEditingFormModalVisible} 
        setEventEditingFormModalVisible={setEventEditingFormModalVisible}
    ...
    <EventsActionRequired setEventEditingFormModalVisible={setEventEditingFormModalVisible}
        email={email} role={role} eventsArray={eventsArray}/>
