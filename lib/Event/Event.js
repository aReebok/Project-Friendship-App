...
const Event = (props) => {
    ...
    const pushRSToArray = (arr, l, p) => {
      ...
      const fetchInfo = async () => {
        ...
        } else return console.log("Note: user is neither a parent nor a mentor");
...
return ( <View style={styles.container}>
    ...
    <View style={styles.card}> 
        <View style={{flexDirection: 'row'}}> 
            ...
            {notification.lenght && <View style={styles.circle}><Text style={{fontSize: 15, color: 'white'}}>{notification.length}</Text></View>}
        </View>
        <ScrollView>
            {/* <EventCard title="Lol"/> */}
